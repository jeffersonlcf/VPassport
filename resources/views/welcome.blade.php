...
<div class="container">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="jumbotron">
                <div class="container">
                    <h1 class="display-3">Volunteer Passport</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque, facilis quo maiores magnam.</p>
                    <p><a class="btn btn-primary btn-lg" href="#" role="button">Learn more »</a></p>
                </div>
            </div>
            <div class="container">
                <h1 class="project-name">Volunteer workflow</h1>
                <div id="timeline">
